	...
	public void run() {
		try {
			...
			case SEND_MONEY:
				...
				Integer twHowMuch = (Integer) in.get(Action.SEND_MONEY);
				Integer twToWhome = (Integer) in.get(Action.TO_WHOME);
